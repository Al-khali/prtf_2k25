...
export const projects: Project[] = [
  // Data/AI Projects
  {
    ...
    description: 'Built scalable data platform handling 50M+ events daily using Airflow, dbt, Airbyte, and Snowflake. Implemented MLOps pipelines for anomaly detection and forecasting models.',
    category: 'data-ai',
    tags: ['Airflow', 'dbt', 'Airbyte', 'Snowflake', 'GCP', 'MLOps', 'Python'],
    image: '/images/projects/placeholder-data.svg',
    metrics: [
      { label: 'Data Volume', value: '50M+ events/day' },
  ...
  {
    id: 'ml-forecasting-system',
    title: 'ML Forecasting & Anomaly Detection',
    description: 'Developed production ML system for time-series forecasting and real-time anomaly detection. Deployed on GCP with automated retraining pipelines and monitoring.',
    category: 'data-ai',
    tags: ['Python', 'TensorFlow', 'MLOps', 'GCP', 'Forecasting', 'Anomaly Detection'],
    image: '/images/projects/ml-rec.png',
    metrics: [
  ...
  },
  {
    ...
    image: '/images/projects/chrun.png',
    metrics: [
  ...
  // Games Projects
  {
    id: 'indie-game-projects',
    title: 'Indie Game Development',
    description: 'Multiple indie game projects in development using Unity and Godot. Features include procedural generation, custom shaders, and innovative gameplay mechanics.',
    category: 'games',
    tags: ['Unity', 'Godot', 'C#', 'GDScript', 'Game Design', 'Shaders'],
    image: '/images/projects/placeholder-game.svg',
    metrics: [
  ...
  },
  {
    ...
    image: '/images/projects/neon-runner.png',
  ...
  },
  {
    ...
    image: '/images/projects/dungeon.png',
  ...
  },
  {
    ...
    image: '/images/projects/voxel.png',
  ...
  },
  {
    ...
    image: '/images/projects/terimnal-quest.png',
  ...
  // Music Projects
  {
    id: 'audio-production-portfolio',
    title: 'Audio Production & Sound Design',
    description: 'Professional sound design and audio production for content creators, podcasts, and digital media. Specializing in mixing, mastering, and custom sound effects.',
    category: 'music',
    tags: ['Sound Design', 'Mixing', 'Mastering', 'Ableton', 'Pro Tools', 'Audio Production'],
    image: '/images/projects/placeholder-audio.svg',
    metrics: [
      { label: 'Projects', value: '20+' },
      { label: 'Clients', value: 'Confidential' },
      { label: 'Speciality', value: 'Sound Design' },
    ],
    featured: true,
    confidential: true,
    status: 'completed',
  },
  {
    ...
    image: '/images/projects/synthesizer.png',
  ...
  },
  {
    ...
    image: '/images/projects/visualizer.png',
  ...
  // Design Projects
  {
    ...
    title: 'Digital & Audiovisual Productions',
    description: 'Creative digital productions including video editing, motion graphics, and multimedia content for various clients and platforms.',
    category: 'design',
    tags: ['Video Editing', 'Motion Graphics', 'After Effects', 'Premiere Pro', 'Digital Media'],
    image: '/images/projects/placeholder-digital.svg',
    metrics: [
      { label: 'Productions', value: '15+' },
      { label: 'Platforms', value: 'Multiple' },
      { label: 'Type', value: 'Multimedia' },
    ],
    confidential: true,
    status: 'completed',
  },
  {
    ...
    description: 'Complete design system with glassmorphism components, modern gradients, and animation library. Built with React and Tailwind.',
    category: 'design',
    tags: ['React', 'Tailwind', 'Design System', 'Storybook'],
    image: '/images/projects/design-system.jpg',
    featured: true,
    github: 'https://github.com/khalid/modern-design',
